...
public class Impression {
    ...
    public void drawStory (SpriteBatch batch, float stateTime){
        ...
        Vector2 size = makeSize.getSize(impression, GameConstant.impressionSize);
        batch.begin();
    ...
    public void drawGame (SpriteBatch batch, float stateTime){
        ...
        MakeSize makeSize = new MakeSize();
        Vector2 size = makeSize.getSize(impressions[countImpress], GameConstant.impressionSize);
